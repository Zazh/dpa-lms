...
# ИИН: 'Имя Фамилия'
HOLDERS = {
    '820825350687': 'Шалынин Андрей',
    # '041202550215': 'Дунаев Константин',
    # '701226300305': 'Охотенко Андрей',
}

# Данные сертификата
COURSE_TITLE = 'Первоначальная теоретическая подготовка операторов БАС Категории 1'
COURSE_FOLDER = 'Первоначальная практическая подготовка операторов БАС Категории 1'
GROUP_NAME = 'Группа А-101'
DOCUMENT_TITLE = 'СЕРТИФИКАТ'
COMPLETION_TEXT = 'успешно завершил(–а) курс'
ISSUE_DATE_LABEL = 'Дата выдачи:'
STAMP_CSS_CLASS = 'stamp-img-2'
SIGNATURE_CSS_CLASS = 'aft-img-1'
SIGNER_NAME = 'Худайбергенова П.Т.'
SIGNER_POSITION = 'Директор ИП MeMar'

# Дата выдачи: None = сегодня, или точная дата date(2026, 2, 10)
ISSUED_AT = date(2026, 2, 25)
